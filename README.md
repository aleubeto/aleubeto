...
<div id="container "style="display:flex; justify-content: space-between; background-color: red">

<div id="section1" style="width:45%; background-color: blue">
...
<div id="section2" style="width:50%; background-color: green">
